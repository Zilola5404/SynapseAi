...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#05070d] text-neutral-100 font-sans selection:bg-cyan-500 selection:text-black">
        ...
        <div className="max-w-7xl 2xl:max-w-[1700px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 2xl:px-6 2xl:py-2.5 text-xs 2xl:text-sm font-bold text-neutral-300 hover:text-white transition-colors"
            >
              Войти
            </button>
            <button
      ...
      <section id="security" className="py-16 2xl:py-28 px-4 sm:px-8 2xl:px-12 bg-[#0b0d11] border-y border-white/10 relative">
        <div className="max-w-6xl 2xl:max-w-[1600px] mx-auto space-y-10 2xl:space-y-16">
          <div className="text-center space-y-3.5">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-green-500/10 border border-green-500/20 text-xs 2xl:text-sm font-mono text-green-400">
              <ShieldCheck className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" />
              <span>INSTITUTIONAL SECURITY & ZERO-TRUST</span>
            </div>
            <h2 className="text-2xl sm:text-4xl 2xl:text-5xl font-black text-white">
              Безопасность институционального уровня
            </h2>
            <p className="text-xs sm:text-sm 2xl:text-lg text-neutral-400 max-w-2xl 2xl:max-w-4xl mx-auto">
      ...
      <section id="demo" className="py-20 2xl:py-28 px-4 sm:px-8 2xl:px-12 max-w-6xl 2xl:max-w-[1600px] mx-auto space-y-10 2xl:space-y-14">
        <div className="text-center space-y-3.5">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-xs 2xl:text-sm font-mono text-emerald-400">
            <Sparkles className="w-4 h-4 2xl:w-5 2xl:h-5 text-emerald-400" />
        ...
        {/* Asset Selector Tabs */}
        <div className="flex flex-wrap items-center justify-center gap-2.5 2xl:gap-4">
          {assets.slice(0, 5).map((a) => (
            <button
              key={a.symbol}
              onClick={() => setSelectedDemoSymbol(a.symbol)}
              className={`px-4 py-2 2xl:px-6 2xl:py-3 rounded-xl 2xl:rounded-2xl text-xs 2xl:text-base font-bold font-mono transition-all border ${
        ...
        <div className="bg-[#0f1118] border border-white/15 rounded-3xl 2xl:rounded-[32px] p-6 sm:p-8 2xl:p-12 shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-80 2xl:w-[500px] h-80 2xl:h-[500px] bg-green-500/5 rounded-full blur-3xl pointer-events-none" />

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 2xl:gap-12 items-start">
            {/* Left: Recommendation Header */}
            <div className="space-y-4 2xl:space-y-6 lg:col-span-1 border-b lg:border-b-0 lg:border-r border-white/10 pb-6 lg:pb-0 lg:pr-8">
              <div className="flex items-center justify-between">
                <span className="text-xl 2xl:text-3xl font-extrabold text-white">{demoAsset.symbol}</span>
                <span className="text-xs 2xl:text-sm px-3 py-1 rounded-lg bg-white/5 border border-white/10 font-mono text-neutral-300">
                  Binance Live
                </span>
              </div>

              <div>
                <span className="text-xs 2xl:text-sm text-neutral-400 block mb-1.5">Рекомендация AI Модели:</span>
                <div className="inline-flex items-center gap-2.5 px-4 py-2.5 2xl:px-6 2xl:py-3 rounded-xl 2xl:rounded-2xl bg-green-500/20 border border-green-500/50 text-green-300 font-extrabold text-lg 2xl:text-2xl">
                  <span>BUY (ПОКУПКА)</span>
                  <CheckCircle2 className="w-5 h-5 2xl:w-7 2xl:h-7 text-green-400" />
                </div>
              </div>

              <div className="grid grid-cols-2 gap-3 2xl:gap-4 pt-2">
                <div className="bg-white/5 p-3.5 2xl:p-5 rounded-xl 2xl:rounded-2xl border border-white/10">
                  <span className="text-[10px] 2xl:text-xs text-neutral-400 block">Уверенность (Confidence)</span>
                  <span className="text-lg 2xl:text-2xl font-black text-green-400 font-mono">88%</span>
                </div>
                <div className="bg-white/5 p-3.5 2xl:p-5 rounded-xl 2xl:rounded-2xl border border-white/10">
                  <span className="text-[10px] 2xl:text-xs text-neutral-400 block">Risk / Reward Ratio</span>
                  <span className="text-lg 2xl:text-2xl font-black text-emerald-400 font-mono">1 : 3.2</span>
                </div>
              </div>

              <div className="bg-white/5 p-3.5 2xl:p-5 rounded-xl 2xl:rounded-2xl border border-white/10 space-y-1.5">
                <div className="flex justify-between text-xs 2xl:text-sm font-mono">
                  <span className="text-neutral-400">Оценка риска:</span>
                  <span className="text-amber-400 font-bold">MEDIUM (3.5 / 10)</span>
                </div>
                <div className="w-full bg-white/10 h-2 2xl:h-3 rounded-full overflow-hidden">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="space-y-2.5">
                <h4 className="text-xs 2xl:text-sm font-bold text-green-400 tracking-wider uppercase font-mono flex items-center gap-2">
                  <Terminal className="w-4 h-4 2xl:w-5 2xl:h-5" />
                  <span>Обоснование решения Gemini AI Neural Agent</span>
                </h4>
                <p className="text-xs sm:text-sm 2xl:text-base text-neutral-200 leading-relaxed bg-black/40 p-4 2xl:p-6 rounded-xl 2xl:rounded-2xl border border-white/10 font-mono">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 2xl:gap-4 text-xs 2xl:text-sm font-mono">
                <div className="bg-white/5 p-3.5 2xl:p-5 rounded-xl 2xl:rounded-2xl border border-white/10">
                  <span className="text-neutral-400 block text-[10px] 2xl:text-xs">Вход (Entry Price):</span>
                  <span className="text-white font-bold">${demoAsset.price.toLocaleString()}</span>
                </div>
                <div className="bg-red-500/10 p-3.5 2xl:p-5 rounded-xl 2xl:rounded-2xl border border-red-500/20">
                  <span className="text-red-400 block text-[10px] 2xl:text-xs">Stop-Loss (2.1%):</span>
                  <span className="text-red-300 font-bold">${(demoAsset.price * 0.979).toFixed(2)}</span>
                </div>
                <div className="bg-green-500/10 p-3.5 2xl:p-5 rounded-xl 2xl:rounded-2xl border border-green-500/20">
                  <span className="text-green-400 block text-[10px] 2xl:text-xs">Take-Profit (6.8%):</span>
                  <span className="text-green-300 font-bold">${(demoAsset.price * 1.068).toFixed(2)}</span>
                </div>
              </div>

              <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4">
                <span className="text-[11px] 2xl:text-xs text-neutral-400">
                  * Все сигналы формируются в режиме реального времени на основе WebSocket потока Binance.
                </span>
                <button
                  onClick={() => onOpenAuth('register')}
                  className="w-full sm:w-auto px-5 py-2.5 2xl:px-7 2xl:py-3 bg-green-500/20 hover:bg-green-500/30 text-green-300 border border-green-500/40 rounded-xl 2xl:rounded-2xl text-xs 2xl:text-sm font-bold transition-all flex items-center justify-center gap-2"
                >
      ...
      <section id="features" className="py-20 2xl:py-28 px-4 sm:px-8 2xl:px-12 bg-[#0a0c10] border-t border-white/10">
        <div className="max-w-6xl 2xl:max-w-[1600px] mx-auto space-y-12 2xl:space-y-16">
          <div className="text-center space-y-3.5">
            <h2 className="text-2xl sm:text-4xl 2xl:text-5xl font-black text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 2xl:gap-12">
            <div className="bg-[#11131a] border border-white/10 rounded-2xl 2xl:rounded-3xl p-6 2xl:p-10 space-y-5">
              <div className="w-12 h-12 2xl:w-16 2xl:h-16 rounded-xl 2xl:rounded-2xl bg-green-500/10 text-green-400 flex items-center justify-center">
                <BarChart3 className="w-6 h-6 2xl:w-8 2xl:h-8" />
              </div>
              <h3 className="text-lg 2xl:text-2xl font-bold text-white">1. AI Portfolio Analysis</h3>
              <p className="text-xs 2xl:text-base text-neutral-400 leading-relaxed">
            ...
            <div className="bg-[#11131a] border border-white/10 rounded-2xl 2xl:rounded-3xl p-6 2xl:p-10 space-y-5">
              <div className="w-12 h-12 2xl:w-16 2xl:h-16 rounded-xl 2xl:rounded-2xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center">
                <ShieldAlert className="w-6 h-6 2xl:w-8 2xl:h-8" />
              </div>
              <h3 className="text-lg 2xl:text-2xl font-bold text-white">2. Risk Guard Engine</h3>
              <p className="text-xs 2xl:text-base text-neutral-400 leading-relaxed">
            ...
            <div className="bg-[#11131a] border border-white/10 rounded-2xl 2xl:rounded-3xl p-6 2xl:p-10 space-y-5">
              <div className="w-12 h-12 2xl:w-16 2xl:h-16 rounded-xl 2xl:rounded-2xl bg-teal-500/10 text-teal-400 flex items-center justify-center">
                <Send className="w-6 h-6 2xl:w-8 2xl:h-8" />
              </div>
              <h3 className="text-lg 2xl:text-2xl font-bold text-white">3. Telegram Signal Bot</h3>
              <p className="text-xs 2xl:text-base text-neutral-400 leading-relaxed">
      ...
      <section id="beta" className="py-20 2xl:py-28 px-4 sm:px-8 2xl:px-12 max-w-5xl 2xl:max-w-[1500px] mx-auto">
        <div className="bg-gradient-to-r from-green-950/40 via-[#0d1219] to-emerald-950/40 border border-green-500/30 rounded-3xl 2xl:rounded-[36px] p-8 sm:p-12 2xl:p-16 shadow-2xl relative overflow-hidden text-center sm:text-left space-y-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 2xl:gap-12">
            <div className="space-y-3.5 max-w-xl 2xl:max-w-3xl">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-green-500/20 border border-green-500/40 text-xs 2xl:text-sm font-mono text-green-300">
                <Award className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" />
                <span>ЗАКРЫТАЯ BETA-ПРОГРАММА SYNAPSE v3.6</span>
              </div>
              <h2 className="text-2xl sm:text-4xl 2xl:text-5xl font-black text-white">
                Присоединяйтесь к раннему доступу
              </h2>
              <p className="text-xs sm:text-sm 2xl:text-lg text-neutral-300 leading-relaxed">
            ...
            <button
              onClick={() => onOpenAuth('register')}
              className="px-8 py-4 2xl:px-10 2xl:py-5 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-400 hover:to-emerald-400 text-black font-extrabold text-sm 2xl:text-lg rounded-2xl shadow-xl shadow-green-500/20 transition-all shrink-0 flex items-center gap-2.5"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 2xl:gap-8 pt-4 border-t border-white/10 text-xs 2xl:text-base">
            <div className="flex items-center gap-2.5 text-neutral-300">
              <CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400 shrink-0" />
      ...
      <section id="pricing" className="py-20 2xl:py-28 px-4 sm:px-8 2xl:px-12 bg-[#080a0d] border-t border-white/10">
        <div className="max-w-6xl 2xl:max-w-[1600px] mx-auto space-y-12 2xl:space-y-16">
          <div className="text-center space-y-3.5">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-green-500/10 border border-green-500/20 text-xs 2xl:text-sm font-mono text-green-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 2xl:gap-10 items-stretch">
            {/* Free Starter */}
            <div className="bg-[#11131a] border border-white/10 rounded-3xl p-6 sm:p-8 2xl:p-10 space-y-6 flex flex-col justify-between">
              <div className="space-y-4">
                <span className="text-xs 2xl:text-sm font-mono text-neutral-400 block uppercase">Free Starter</span>
                <div className="text-3xl 2xl:text-5xl font-black text-white">$0 <span className="text-xs 2xl:text-base font-normal text-neutral-400">/ навсегда</span></div>
                <p className="text-xs 2xl:text-sm text-neutral-400">Для знакомства с платформой и мониторинга нескольких основных активов.</p>
                <ul className="space-y-3 text-xs 2xl:text-sm text-neutral-300 pt-2">
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Read-Only подключение Binance</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Мониторинг 3 пар на выбор</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Базовый AI-анализ тренда</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Ручные Telegram-алерты</li>
                </ul>
              </div>
              <button
                onClick={() => onOpenAuth('register')}
                className="w-full py-3.5 2xl:py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bold rounded-xl 2xl:rounded-2xl text-xs 2xl:text-base transition-all"
              >
                Начать бесплатно
              </button>
            </div>
            ...
            {/* Pro Analyst (POPULAR) */}
            <div className="bg-[#0f151c] border-2 border-green-500 rounded-3xl p-6 sm:p-8 2xl:p-10 space-y-6 flex flex-col justify-between relative shadow-2xl shadow-green-500/10">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-3 py-1 2xl:px-4 2xl:py-1.5 bg-green-500 text-black font-extrabold text-[10px] 2xl:text-xs rounded-full uppercase tracking-wider font-mono">
                ПОПУЛЯРНЫЙ ВЫБОР
              </div>
              <div className="space-y-4">
                <span className="text-xs 2xl:text-sm font-mono text-green-400 block uppercase">Pro Analyst</span>
                <div className="text-3xl 2xl:text-5xl font-black text-white">$49 <span className="text-xs 2xl:text-base font-normal text-neutral-400">/ месяц</span></div>
                <p className="text-xs 2xl:text-sm text-neutral-300">Полный пакет AI-управления портфелем и зашита от глубоких просадок.</p>
                <ul className="space-y-3 text-xs 2xl:text-sm text-neutral-200 pt-2">
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Полный охват 25+ пар Binance</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> AI Portfolio Risk Guard Engine</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Безлимитные Telegram-алерты 24/7</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Симулятор бэктестов на истории</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Рекомендации по ребалансировке</li>
                </ul>
              </div>
              <button
                onClick={() => onOpenAuth('register')}
                className="w-full py-3.5 2xl:py-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-black font-extrabold rounded-xl 2xl:rounded-2xl text-xs 2xl:text-base transition-all shadow-lg shadow-green-500/20"
              >
            ...
            <div className="bg-[#11131a] border border-white/10 rounded-3xl p-6 sm:p-8 2xl:p-10 space-y-6 flex flex-col justify-between">
              <div className="space-y-4">
                <span className="text-xs 2xl:text-sm font-mono text-teal-400 block uppercase">Institutional VIP</span>
                <div className="text-3xl 2xl:text-5xl font-black text-white">$199 <span className="text-xs 2xl:text-base font-normal text-neutral-400">/ месяц</span></div>
                <p className="text-xs 2xl:text-sm text-neutral-400">Для крупных капиталов и семейных офисов с индивидуальной поддержкой.</p>
                <ul className="space-y-3 text-xs 2xl:text-sm text-neutral-300 pt-2">
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Доступ к Multi-Agent hedge fund моделям</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Выделенный серверный канал данных</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Персональный менеджер рисков</li>
                  <li className="flex items-center gap-2.5"><CheckCircle2 className="w-4 h-4 2xl:w-5 2xl:h-5 text-green-400" /> Кастомные вебхуки и API интеграции</li>
                </ul>
              </div>
              <button
                onClick={() => onOpenAuth('register')}
      ...
      {/* FAQ SECTION */}
      <section id="faq" className="py-20 2xl:py-28 px-4 sm:px-8 2xl:px-12 max-w-4xl 2xl:max-w-6xl mx-auto space-y-10 2xl:space-y-14">
        <div className="text-center space-y-3.5">
          <h2 className="text-2xl sm:text-4xl 2xl:text-5xl font-black text-white">
            Часто задаваемые вопросы (FAQ)
          </h2>
          <p className="text-xs sm:text-sm 2xl:text-lg text-neutral-400">
        ...
        <div className="space-y-4">
          {faqList.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-[#0f1118] border border-white/10 rounded-2xl 2xl:rounded-3xl overflow-hidden transition-all"
              >
                <button
                  onClick={() => setOpenFaqIndex(isOpen ? null : idx)}
                  className="w-full px-6 py-4 2xl:px-8 2xl:py-6 text-left flex items-center justify-between text-sm sm:text-base 2xl:text-xl font-bold text-white hover:text-green-400 transition-colors"
                >
                  <span>{item.q}</span>
                  <ChevronDown className={`w-5 h-5 2xl:w-6 2xl:h-6 text-neutral-400 transition-transform ${isOpen ? 'rotate-180 text-green-400' : ''}`} />
                </button>
                {isOpen && (
                  <div className="px-6 pb-5 2xl:px-8 2xl:pb-6 text-xs sm:text-sm 2xl:text-base text-neutral-300 leading-relaxed border-t border-white/5 pt-3.5">
                    {item.a}
                  </div>
                )}
              </div>
      ...
      {/* FOOTER */}
      <footer className="border-t border-white/10 py-10 2xl:py-16 px-4 sm:px-8 2xl:px-12 bg-[#050608] text-neutral-500 text-xs 2xl:text-sm">
        <div className="max-w-7xl 2xl:max-w-[1700px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3.5">
            <div className="w-8 h-8 2xl:w-10 2xl:h-10 rounded-lg bg-green-500/20 text-green-400 flex items-center justify-center font-bold">
              <Bot className="w-5 h-5 2xl:w-6 2xl:h-6" />
            </div>
            <div>
              <span className="font-extrabold text-white text-sm 2xl:text-base">SYNAPSE AI</span>
              <p className="text-[11px] 2xl:text-xs text-neutral-500">Institutional Crypto Intelligence Platform © 2026</p>
            </div>
          </div>
